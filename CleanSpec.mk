...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/etc/permissions/handheld_core_hardware.xml)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/etc/permissions/android.hardware.fingerprint.xml)
